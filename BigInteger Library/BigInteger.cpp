...
char* BigInteger::add(const BigInteger &num) {
...
bool BigInteger::isSmaller(const char *n1, const char *n2) {
	int n1Len = strlen(n1);
	int n2Len = strlen(n2);
...
char* BigInteger::operation(char ops, const char *n1, const char *n2) {
...
const char* BigInteger::sub(const BigInteger &num) {
...
const char* BigInteger::multipliar(const char* n1, const char* n2)
{
...
const char* BigInteger::mul(const BigInteger &num)
{
	bool negSign = 0;
